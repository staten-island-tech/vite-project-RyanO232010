import "./style.css";
  ...
  const cards = [
    ...
    { name: "South Korea Flag", img: "/Flags/south_korea.png", category: "Flags" },
    ...
    { name: "New Zealand Flag", img: "/Flags/new_zealand.png", category: "Flags" },
    { name: "South Africa Flag", img: "/Flags/south_africa.png", category: "Flags" },
    ...
    { name: "Queen of Diamonds", img: "/Poker/Q_diamonds.png", category: "Poker" },
  ...
  <div>
    ...
    <div class="menu">
      <div class="Versions">
        ...
        <button class="filterb" data-category="Poker">Poker Cards ( Hard )</button>
      </div>
    </div>
  </div>
`;
